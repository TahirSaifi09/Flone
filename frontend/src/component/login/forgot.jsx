  ...
  return (
    <div>
      <div className="flex justify-center ">
        <div className="w-2/5 mt-12 shadow-2xl border border-gray-200 h-full max-md:w-screen max-md:h-screen max-md:mt-0">
          ...
          <div className="px-10 pb-12 ">
            <form>
              ...
              <Link to="#">
                <button className="h-12 border w-full bg-black text-white mt-4">
            ...
            <Link
              to="/Login"
              className="text-blue-800 flex justify-center mt-4"
            >
              Back to login
            </Link>
          </div>
