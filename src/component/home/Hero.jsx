    ...
    <div className="h-full overflow-hidden">
      <Slider {...settings} className="bg-pink-100 slide-button">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex-slider pt-10 2xl:pt-24 px-4 sm:px-10 2xl:px-44 sm:flex max-sm:flex-wrap font-medium items-center"
          >
            <div className="flex max-md:text-center max-md:justify-center flex-wrap gap-4">
              <h2 className="text-3xl">{item.h2}</h2>
              <p className="text-3xl lg:text-7xl">{item.para}</p>
